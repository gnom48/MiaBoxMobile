...
class CallsAdapter(private val context: Context, private val callsGroups: List<CallsGroup>, private val callsRecords: List<CallRecord>): RecyclerView.Adapter<CallsAdapter.ItemViewHolder>() {
